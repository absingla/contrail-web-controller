...
module.exports = function (grunt) {
    ...
    var commonFiles = [
        //{pattern: 'contrail-web-core/webroot/assets/fonts-opensans/**/*.woff', included: false},
        ...
        {pattern: 'contrail-web-controller/webroot/test/mvc/common/ct.test.app.js'},
        {pattern: 'contrail-web-controller/webroot/test/mvc/common/*.js', included: false},
        {pattern: 'contrail-web-controller/webroot/test/mvc/*.js', included: false},
