...
function runStatQuery(queryPrefix) {
    ...
    if ($(queryFormId).valid()) {
        var reqQueryObj = $(queryFormId).serializeObject(),
            ...
            options = getDefaultOptions(queryPrefix, false),
            queryId, statQueryGridDisplay, selectArray, columnDisplayArray, labelStepUnit, tg, tgUnit;
...
statQuery['columnDisplay']  = {
    ...
    "StatTable.GeneratorDbStats.table_info" : [
        {select:"COUNT(table_info)", display:{id:'COUNT(table_info)', field:'COUNT(table_info)', width:120, name:"Count", format:"{0:n0}", groupable:false}},
    ...
    "StatTable.GeneratorDbStats.errors" : [
        {select:"COUNT(errors)", display:{id:'COUNT(errors)', field:'COUNT(errors)', width:120, name:"Count", format:"{0:n0}", groupable:false}},
    ...
    "StatTable.FieldNames.fields" : [
        {select:"COUNT(fields)", display:{id:'COUNT(fields)', field:'COUNT(fields)', width:120, name:"Count", format:"{0:n0}", groupable:false}},
    ...
    "StatTable.FieldNames.fieldi" : [
        {select:"COUNT(fieldi)", display:{id:'COUNT(fieldi)', field:'COUNT(fieldi)', width:120, name:"Count", format:"{0:n0}", groupable:false}},
    ...
    "StatTable.QueryPerfInfo.query_stats" : [
        {select:"COUNT(query_stats)", display:{id:'COUNT(query_stats)', field:'COUNT(query_stats)', width:120, name:"Count", format:"{0:n0}", groupable:false}},
