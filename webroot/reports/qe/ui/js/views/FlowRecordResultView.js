    ...
    var FlowRecordResultView = QueryResultView.extend({
        render: function () {
            ...
            $.ajax({
                ...
                self.renderView4Config(self.$el, contrailListModel, self.getFlowRecordResultGridTabViewConfig(postDataObj, frRemoteConfig, serverCurrentTime), null, null, modelMap, function() {
