...
define([
    ...
    var columnDisplayMap  = {
        "FlowSeriesTable": [
            ...
            {select:"dport", display:{id:"dport", field:"dport", width:140, name:"Destination Port", groupable:false, formatter: function(r, c, v, cd, dc){ return handleNull4Grid(dc.dport);}}},
