    ...
    var NetworkView = Backbone.View.extend({
        ...
        renderNetworkGraph: function(networkFQN, networkUUID) {
            var topContainerElement = $('#' + ctwl.TOP_CONTENT_CONTAINER),
                connectedGraph = ctwu.getNetworkingGraphConfig(ctwc.get(ctwc.URL_NETWORK_CONNECTED_GRAPH, networkFQN), {fqName: networkFQN}, ':connected', ctwc.GRAPH_ELEMENT_NETWORK),
                configGraph = ctwu.getNetworkingGraphConfig(ctwc.get(ctwc.URL_NETWORK_CONFIG_GRAPH, networkFQN), {fqName: networkFQN}, ':config', ctwc.GRAPH_ELEMENT_NETWORK);
