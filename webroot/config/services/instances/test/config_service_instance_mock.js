...
*/
    ...
    this.getdomData = function() {
	   var domStr= '<div class="row-fluid">';
           ...
           domStr+= '<select id="ddDomainSwitcher" class="span2"></select>';
           domStr+= '<select id="ddProjectSwitcher" class="span2"></select>';
           domStr+= '<div class="span8">';
           ...
           domStr+= '<div class="row-fluid">';
           domStr+= '<iframe id="vnc-console-frame" src="" class="span12 height-840"></iframe>';
           domStr+= '</div>';
           domStr+= '</div>';
           domStr+= '</div>';
           domStr+= '</div>';
	...
	var domStr = SIMock.getdomData();
        ...
        domStr += '<label class="control-label" class="span3">Instance Name</label>';
        domStr += '<div class="controls">';
        domStr += '<div class="row-fluid">';
        domStr += '<input type="text" id="txtsvcInstanceName" class="span10"/>';
        domStr += '</div>';
        domStr += '</div>';
        domStr += '</div>';
        domStr += '<div class="control-group ">';
        domStr += '<label class="control-label" class="span3">Services Template</label>';
        domStr += '<div class="controls">';
        domStr += '<div class="row-fluid">';
        domStr += '<select type="text" id="ddsvcTemplate" class="span10"></select>';
        domStr += '</div>';
        domStr += '</div>';
        domStr += '</div>';
        ...
        domStr += '<div class="controls">';
        domStr += '<div class="row-fluid">';
        domStr += '<input type="text" id="txtMaximumInstances" class="span10"/>';
        domStr += '</div>';
        domStr += '</div>';
        domStr += '</div>';
